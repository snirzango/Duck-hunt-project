...
////// Specular:
                ...
                float3 diffuseColor = lerp((_splatmap_var.rgb.r*_RedColor_var.rgb + _splatmap_var.rgb.g*_GreenColor_var.rgb + _splatmap_var.rgb.b*_BlueColor_var.rgb),_MainTex_var.rgb,_blend); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _BlueColor_var = tex2D(_BlueColor,TRANSFORM_TEX(node_3085, _BlueColor));
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float3 diffColor = lerp((_splatmap_var.rgb.r*_RedColor_var.rgb + _splatmap_var.rgb.g*_GreenColor_var.rgb + _splatmap_var.rgb.b*_BlueColor_var.rgb),_MainTex_var.rgb,_blend);
                float4 _BaseSpecular_var = tex2D(_BaseSpecular,TRANSFORM_TEX(i.uv0, _BaseSpecular));
